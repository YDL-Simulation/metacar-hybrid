...
class SimCarMsg(BaseModel):
    ...
    hybrid_control: dict | None = Field(
        default=None,
        alias="HybridControl",
        description="混合控制信息（deltaTime 等）",
    )
...
class SimCarMsgOutput(BaseModel):
    ...
    hybrid_control: dict | None = Field(
        default=None,
        serialization_alias="HybridControl",
        description="混合控制信息（deltaTime 等）",
    )
    vehicle_control: VehicleControlDTO | None = Field(
        default=None, serialization_alias="VehicleControl"
    )
